...
class UserPair(models.Model):
    ...
    donor = models.ForeignKey('UserIDMap', on_delete=models.CASCADE, null=True,
                              related_name='up_donor_fk')
    recipient = models.ForeignKey('UserIDMap', on_delete=models.CASCADE, null=True,
                                  related_name='up_recipient_fk')


class Goal(models.Model):
    id = models.IntegerField(primary_key=True)
    user = models.ForeignKey('UserIDMap', on_delete=models.CASCADE, null=True,
...
class Activity(models.Model):
    ...
    user = models.ForeignKey('UserIDMap', on_delete=models.PROTECT, null=True,
